...
int main(int argc, char **argv) {
    ...
    //::testing::GTEST_FLAG(filter) = "HighLevelScheduleTest.CFPullParallel";
    ...
    //::testing::GTEST_FLAG(filter) = "HighLevelScheduleTest.PageRankDeltaPullParallelFuseFieldsLoadBalance";
