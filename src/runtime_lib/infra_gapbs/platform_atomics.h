...
*/
    ...
    static bool compare_and_swap(float &x, const float &old_val, const float &new_val) {
    ...
    static bool compare_and_swap(double &x, const double &old_val, const double &new_val) {
