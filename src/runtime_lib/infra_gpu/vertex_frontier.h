...
static VertexFrontier create_new_vertex_set(int32_t num_vertices) {
	...
	cudaMalloc(&frontier.d_num_elems_input, sizeof(int32_t) * 3);
	cudaMalloc(&frontier.d_num_elems_output, sizeof(int32_t) * 3);
	cudaMemset(frontier.d_num_elems_input, 0, sizeof(int32_t) * 3);
	cudaMemset(frontier.d_num_elems_output, 0, sizeof(int32_t) * 3);
