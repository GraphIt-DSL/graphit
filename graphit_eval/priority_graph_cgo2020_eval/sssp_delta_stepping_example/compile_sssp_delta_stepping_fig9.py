...
input_schedules_path = '../../graphit_eval/priority_graph_cgo2020_eval/sssp_delta_stepping_example/schedules/'
sssp_demo_dir = '../../graphit_eval/priority_graph_cgo2020_eval/sssp_delta_stepping_example'
...
def eval_schedules():
    myprint("Reproducing Fig.9: Generating different SSSP Delta Stepping C++ implemenataion with different schedules. Schedules are stored in the ./schedules directory. The algorithm file (sssp_delta_stepping.gt) is in graphit/apps directiory. ")

    # Fig 6(a) The default schedule
    compile_and_myprint("SparsePush_VertexParallel_Delta2.gt", "SparsePush VertexParallel schedule Fig 6(a)", sssp_demo_dir + "sssp_delta_stepping_SparsePush_VertexParallel_schedule.cpp")
