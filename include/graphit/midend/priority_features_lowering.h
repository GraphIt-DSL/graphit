    ...
    public:
        ...
        struct LowerPriorityRelatedTypeAndExpr : public mir::MIRVisitor {
            ...
            void visit(mir::PriorityQueueType::Ptr priority_queue_type) {
                priority_queue_type->setMetadata<mir::PriorityUpdateType>("priority_update_type", mir_context_->priority_update_type);
            }

            void visit(mir::PriorityQueueAllocExpr::Ptr priority_queue_alloc_expr) {
                priority_queue_alloc_expr->setMetadata<mir::PriorityUpdateType>("priority_update_type", mir_context_->priority_update_type);
                priority_queue_alloc_expr->setMetadata<int>("delta", mir_context_->delta_);
            ...
            void visit(mir::EdgeSetLoadExpr::Ptr edgeset_load_expr) {
                edgeset_load_expr->setMetadata<mir::PriorityUpdateType>("priority_update_type", mir_context_->priority_update_type);
            }

            void visit(mir::VertexSetType::Ptr vertex_set_type) {
                vertex_set_type->setMetadata<mir::PriorityUpdateType>("priority_update_type", mir_context_->priority_update_type);
            }

            void visit(mir::EdgeSetType::Ptr edge_set_type) {
                edge_set_type->setMetadata<mir::PriorityUpdateType>("priority_update_type", mir_context_->priority_update_type);
            }
