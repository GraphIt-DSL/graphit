...
class SimpleGPUSchedule: public GPUSchedule, public abstract_schedule::SimpleScheduleObject {
...
class HybridGPUSchedule: public GPUSchedule, public abstract_schedule::CompositeScheduleObject {
private:
